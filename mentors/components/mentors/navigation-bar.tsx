...
import { Bell, Menu, Search, MessageSquare, Users, BookOpen, Settings, LogOut, Router } from 'lucide-react'
        ...
        <div className="flex justify-between py-5">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/dashboard">
                <Image src="/images/face.svg" alt="Nikonekti" width={50} height={40} />
              </Link>
            </div>
