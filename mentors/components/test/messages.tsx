...
export default function MentorChatPage() {
    ...
    const [filteredConnections, setFilteredConnections] = useState<Conversation[]>([])
    ...
    const handleConversationClick = (conversation: Conversation) => {
        ...
        socket.emit("join_room", data, (response: any) => {
    ...
    return (
        <div className="container mx-auto p-4 h-[calc(100vh-4rem)] flex flex-col">
            <div className='w-full flex justify-between items-center'>
                <h1 className="text-2xl font-bold uppercase text-blue-700 mb-4">Mentees</h1>
            </div>
                            ...
                            <div className="p-4 border-b">
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="pl-10 w-full border-none !outline-none ring-0 focus:ring-0 focus:ring-offset-0"
                                        value={searchTerm}
                            ...
                            <ScrollArea className="h-[calc(100vh-16rem)]">
                                {filteredConnections.map((conv) => (
                                    <motion.div
                                        ...
                                        transition={{ duration: 0.3 }}
                                        className={`flex items-center p-4 cursor-pointer hover:bg-blue-50 ${activeConversation?.id === conv.id ? '' : ''}`}
